...
# Container-first. We only ensure Docker Desktop and then start the DB compose stack.
...
$services = [pscustomobject]@{
  database = [pscustomobject]@{ mode = $DatabaseMode; composeFile = 'compose/db.compose.yaml' }
  web = [pscustomobject]@{ mode = 'Skip'; composeFile = 'compose/web.compose.yaml' }
